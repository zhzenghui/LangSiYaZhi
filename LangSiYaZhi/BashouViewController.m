...
@interface BashouViewController ()
{
    int current;
    int previous;
    int numberOfImages;
...
@implementation BashouViewController
...
- (void)viewDidLoad
{
    ...
    image_back.image = [UIImage imageNamed:@"lens五金预览-背景-把手.png"];
    ...
    blackground.image = [UIImage imageNamed:@"F_1.png"];
...
{
    i=1;
    NSString *path = [NSString stringWithFormat:@"F_%d", current];
...
{
    i=2;
    NSString *path = [NSString stringWithFormat:@"H_%d", current];
    path = [[NSBundle mainBundle] pathForResource:path ofType:@"png"];
    UIImage* img =  [[UIImage alloc] initWithContentsOfFile:path];
    [blackground setImage:img];
    [img release];
...
{
    i=3;
    NSString *path = [NSString stringWithFormat:@"J_%d", current];
    path = [[NSBundle mainBundle] pathForResource:path ofType:@"png"];
    UIImage* img =  [[UIImage alloc] initWithContentsOfFile:path];
    [blackground setImage:img];
    [img release];
...
{
    i=4;
    NSString *path = [NSString stringWithFormat:@"G_%d", current];
    path = [[NSBundle mainBundle] pathForResource:path ofType:@"png"];
    UIImage* img =  [[UIImage alloc] initWithContentsOfFile:path];
    [blackground setImage:img];
    [img release];
...
{
    i=5;
    NSString *path = [NSString stringWithFormat:@"I_%d", current];
    path = [[NSBundle mainBundle] pathForResource:path ofType:@"png"];
    UIImage* img =  [[UIImage alloc] initWithContentsOfFile:path];
    [blackground setImage:img];
    [img release];
