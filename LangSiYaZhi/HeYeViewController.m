...
@implementation HeYeViewController
...
- (void)viewDidLoad
{
    ...
    image_back.image = [UIImage imageNamed:@"lens五金预览-背景-180度左外开合页.png"];
    ...
    blackground.image = [UIImage imageNamed:@"A_1.png"];
...
{
    i=1;
    NSString *path = [NSString stringWithFormat:@"A_%d", current];
...
{
    i=2;
    NSString *path = [NSString stringWithFormat:@"C_%d", current];
    path = [[NSBundle mainBundle] pathForResource:path ofType:@"png"];
    UIImage* img =  [[UIImage alloc] initWithContentsOfFile:path];
    [blackground setImage:img];
    [img release];
...
{
    i=3;
    NSString *path = [NSString stringWithFormat:@"E_%d", current];
    path = [[NSBundle mainBundle] pathForResource:path ofType:@"png"];
    UIImage* img =  [[UIImage alloc] initWithContentsOfFile:path];
    [blackground setImage:img];
    [img release];
...
{
    i=4;
    NSString *path = [NSString stringWithFormat:@"B_%d", current];
    path = [[NSBundle mainBundle] pathForResource:path ofType:@"png"];
    UIImage* img =  [[UIImage alloc] initWithContentsOfFile:path];
    [blackground setImage:img];
    [img release];
...
{
    i=5;
    NSString *path = [NSString stringWithFormat:@"D_%d", current];
    path = [[NSBundle mainBundle] pathForResource:path ofType:@"png"];
    UIImage* img =  [[UIImage alloc] initWithContentsOfFile:path];
    [blackground setImage:img];
    [img release];
